...
replace (
	github.com/rancher/lasso => github.com/chiukapoor/lasso v0.0.0-20250520082556-aafb84d537de
	github.com/rancher/wrangler/v3 => github.com/chiukapoor/wrangler/v3 v3.0.0-20250520083202-e803af9eec4c
)

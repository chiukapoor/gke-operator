...
replace (
	github.com/rancher/lasso => github.com/chiukapoor/lasso v0.0.0-20241226120549-4e5ac61f5c3b
	github.com/rancher/wrangler/v3 => github.com/chiukapoor/wrangler/v3 v3.0.0-20250124061410-3de55bacfaf7
)
